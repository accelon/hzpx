...
与过去所有字形产生器的关键差别是，采用部件「置换」，而不是部件「叠加」来来描述汉字。比方说要组[萌-日+囧](moe.jpg?raw=true)，叠加法列出部件及组合方式，例如「⿱艹⿰囧月」（「囧」「月」左右组合之後，再和「艹」上下组合，这是Unicode IDS语法）。

以「汉字拼形式」表达，「萌日囧」🡺[萌-日+囧](moe.jpg?raw=true)，意思是将「萌」中的「日」，替换成「囧」。「萌」是此式子中的基础字，简称基字。
...
由於「朙」是「明」的异体。理论上，从「明」衍生的字，如奛、盟都可以替换部件，衍生新字的数量远比想像的多，采用汉字拼形，皆可表达：「盟日囧」得 [盟日囧](moe2.png?raw=true)，  「奛日囧」得 [奛日囧](moe3.png?raw=true)。

替换的部件也可以是另一个拼形式子，利用这个特性可以组合复杂的合文。

 例： 「邏羅寶貝𩀨從䞃致招」🡺 [招財進寶](fortune.png?raw=true)。也就是基字「邏」後面的字为一减一加，即「邏羅寶貝𩀨從䞃致招」为「邏-羅+寶-貝+𩀨-從+䞃-致+招」，意思是：将「邏」中的「羅」替换为「寶」，「寶」中的「貝」替换为「𩀨」，「𩀨」中的「從」替换为「䞃」，「䞃」中的「致」替换为「招」。听起来有点繁琐，但对计算机来说只是很简单的套叠操作。
...
不如将错字与正字一视同仁，教科书编辑者可省去Photoshop 制图的工夫。例： [初-衤+礻](wrongfirst.png?raw=true)为初之误。

* 问：现代还有造新字的需要吗？

[牙合](occlusion.png?raw=true)，口腔医学用字，Occlusion之译。1945年造，直到2015年才收进第五次扩编(Extension E)。
[人工石](concrete.png?raw=true)，混凝土，即「人工石」，音「同」，1953年造，建筑业常用字。
2017年5月，国家语言文字委员会发布了四个新的化学元素用字。[e113](e113.png?raw=true) [e115](e115.png?raw=true) [e117](e117.png?raw=true) [e118](e118.png?raw=true)，原子序数分别为113, 115,117,118。

* 问：新字如何检索及输入？
「汉字拼形式」可展开成部件集，将「萌日囧」[萌-日+囧](moe.jpg?raw=true)，展开为「萌、艹、明、日、月、囧」，使用者可用熟悉的输入法，输入一个或多个部件即可检出。具体的实现有台湾开放古籍协会康熙字典的「部件」搜寻功能，「汉文博士」软件也有类似功能。
...
以下饱含新字的句子，诸君能识否？
[气电车](gasecar.png?raw=true)车只是过渡方案，[电车](ecar.png?raw=true)最终将完全取代取代[汽车](gas.png?raw=true)。
[新冠](covid.png?raw=true)改变了世界的格局，为[目英](eng.png?raw=true)[目美](usa.png?raw=true)[目加](canada.png?raw=true)[目新](nz.png?raw=true)[目澳](aus.png?raw=true)所不乐见。
乾净能源如[水电](water.png?raw=true) [风电](wind.png?raw=true) [太阳电](solar.png?raw=true)
代替 [火电](fire.png?raw=true)
...
[^7]: [无字库汉字系统](http://www.chancezoo.net)
[^8]: 内嵌在Accelon3 系统中，从Unicode IDS式子「⿴辶⿱宀⿱珤⿰隹⿰贝招」直接生成 
[^9]:   [Character Description Language ](http://www.wenlininstitute.org)
[^10]:  [Kage 系统](https://kamichi.jp) 
